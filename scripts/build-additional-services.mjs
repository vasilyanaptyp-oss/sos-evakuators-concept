...
function head(lang,page,title,description,from,ogImage){const canonical=absolute(ROUTES[page][lang]);const pageRobots=PRODUCTION?(["hub","fitness","wells"].includes(page)?"index, follow":"noindex, follow"):"noindex, nofollow";const alternates=LANGS.map(code=>`<link rel="alternate" hreflang="${code}" href="${absolute(ROUTES[page][code])}">`).join("\n  ");return `<meta charset="utf-8">
  ...
  <meta http-equiv="Content-Security-Policy" content="default-src 'self'; img-src 'self' data: https://www.googletagmanager.com https://googleads.g.doubleclick.net https://www.google.com https://google.com https://www.google.lv https://www.google.lt https://www.google.ee https://pagead2.googlesyndication.com https://www.googleadservices.com; font-src 'self'; style-src 'self'; script-src 'self' https://www.googletagmanager.com https://www.googleadservices.com https://www.google.com https://pagead2.googlesyndication.com https://googleads.g.doubleclick.net; connect-src 'self' https://pagead2.googlesyndication.com https://www.googleadservices.com https://googleads.g.doubleclick.net https://ad.doubleclick.net https://www.google.com https://google.com https://www.google.lv https://www.google.lt https://www.google.ee https://*.googletagmanager.com; frame-src https://www.googletagmanager.com https://td.doubleclick.net; object-src 'none'; base-uri 'none'">
...
<body>
  ...
  <script src="${rel(from,[])}assets/js/analytics.js?v=20260917-ads" defer></script>
</body>
</html>\n`;}
